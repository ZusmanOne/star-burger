...
[Адрес сайта](https://star-burger.jeffreysinfo.ru/)
...
- `YANDEX_API_KEY` - [по этой ссылке узнаешь как получить API_KEY](https://dvmn.org/encyclopedia/api-docs/yandex-geocoder-api/)
